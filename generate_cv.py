...
class PDF(FPDF):
    def header(self):
        ...
        self.set_fill_color(52, 152, 219)  # Blue color
        self.rect(0, 0, 210, 15, 'F')
        self.ln(20)  # Move below the blue bar
...
def generate_cv():
    ...
    # Contact Info
    pdf.set_font("Arial", "", 10)  # Slightly smaller font for contact info
    contact_info = (
    ...
    skills = (
        ...
        "- Web Development: HTML (Advanced), CSS (Advanced), Angular.js (Working Knowledge), Responsive Web Design\n"
